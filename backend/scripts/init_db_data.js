    ...
    try {
        ...
        const sessionObj1 = {
            ...
            areas: [
                ...
                { area_id: 2, area_name: "VIP 2", price: 6888, max_seats: 100 },
                { area_id: 3, area_name: "特A區", price: 6600, max_seats: 100 },
                { area_id: 4, area_name: "特B區", price: 6600, max_seats: 100 },
                { area_id: 5, area_name: "藍1A-1", price: 5800, max_seats: 100 },
                { area_id: 6, area_name: "藍1A-2", price: 5800, max_seats: 100 },
                { area_id: 7, area_name: "藍2A-1", price: 5800, max_seats: 100 },
        ...
        await insertSessionData(sessionsCollection, seatsCollection, [sessionObj1, sessionObj2, sessionObj3]);
